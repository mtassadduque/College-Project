"""
Django settings for the Government College of Technology,
Samanabad, Faisalabad website.
"""
...
# Database
# Using SQLite for easy local development. Swap for Postgres/MySQL in production.
DATABASES = {
    'default': {
